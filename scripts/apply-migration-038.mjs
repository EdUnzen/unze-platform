...
const MIGRATION = join(root, "database", "migrations", "038_beta_finalization.sql");
...
async function main() {
  ...
  console.log("\n=== UNZE Migration 038 (Beta Finalization) ===\n");
  await client.connect();
  try {
    await client.query(sql);
    console.log("038_beta_finalization.sql angewendet\n");
  } finally {
    await client.end();
  }
}
