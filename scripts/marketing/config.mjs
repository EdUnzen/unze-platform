...
export const CAPTURE_ROUTES = [
  ...
  { id: "profile", path: "/profile", auth: true },
  { id: "profile-settings", path: "/profile/settings", auth: true },
  { id: "profile-aktivitaet", path: "/profile/aktivitaet", auth: true },
  { id: "profile-tickets", path: "/profile/tickets", auth: true },
  { id: "notifications", path: "/notifications", auth: true },
  { id: "favorites", path: "/favorites", auth: true },
  { id: "verify-creator", path: "/verify/creator", auth: true },
  { id: "group-coaching", path: "/community/rocket-league-ssl/group/einzelcoaching", auth: false },
  { id: "event-cup", path: "/community/rocket-league-ssl/event/ssl-community-cup", auth: false },
  { id: "community-members-tab", path: "/community/rocket-league-ssl?tab=members", auth: false },
  { id: "discover-groups", path: "/discover?tab=groups", auth: false },
  { id: "dash-community", path: "/dashboard/community/rocket-league-ssl", auth: true },
  { id: "groups-dash", path: "/dashboard/community/rocket-league-ssl/groups", auth: true },
  { id: "requests", path: "/dashboard/community/rocket-league-ssl/requests", auth: true },
  { id: "roles", path: "/dashboard/community/rocket-league-ssl/roles", auth: true },
  { id: "settings", path: "/dashboard/community/rocket-league-ssl/settings", auth: true },
  { id: "access", path: "/dashboard/community/rocket-league-ssl/access", auth: true },
  { id: "moderation", path: "/dashboard/community/rocket-league-ssl/moderation", auth: true },
  { id: "creator-profile", path: "/creator/edudemo", auth: false },
