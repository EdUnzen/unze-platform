...
const MIGRATION = join(root, "database", "migrations", "030_membership_soft_delete_checks.sql");
...
async function main() {
  ...
  await client.end();
  console.log("✓ 030_membership_soft_delete_checks.sql angewendet");
}
