...
const MIGRATION = join(root, "database", "migrations", "027_backfill_creator_memberships.sql");
...
async function main() {
  ...
  await client.end();
  console.log("✓ 027_backfill_creator_memberships.sql angewendet");
}
