...
const MIGRATION = join(root, "database", "migrations", "040_business_studio_schemas.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("Migration 040_business_studio_schemas.sql angewendet.");
  } finally {
    await client.end();
  }
}
