...
const MIGRATION = join(root, "database", "migrations", "039_check_in_rewards_feedback.sql");
...
async function main() {
  ...
  console.log("\n=== UNZE Migration 039 (Check-In Rewards Feedback) ===\n");
  await client.connect();
  try {
    await client.query(sql);
    console.log("039_check_in_rewards_feedback.sql angewendet\n");
  } finally {
    await client.end();
  }
}
