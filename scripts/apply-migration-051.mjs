#!/usr/bin/env node
/** Usage: node scripts/apply-migration-051.mjs */
...
const MIGRATION = join(root, "database", "migrations", "051_award_permissions.sql");
...
async function main() {
  ...
  console.log("\n=== UNZE Migration 051 (Award Permissions) ===\n");
  await client.connect();
  try {
    await client.query(sql);
    console.log("051_award_permissions.sql angewendet\n");
  } finally {
    await client.end();
  }
}
