#!/usr/bin/env node
/**
 * Wendet Migration 026 an (Creator-Mitgliedschaft RLS).
 * Usage: npm run db:migrate:026
 */
...
const MIGRATION_FILE = "026_community_creator_membership.sql";
...
async function main() {
  ...
  console.error(`  SQL Editor: database/migrations/${MIGRATION_FILE}\n`);
  process.exit(1);
}
