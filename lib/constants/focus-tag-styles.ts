...
const FOCUS_TAG_STYLES: Record<string, string> = {
  ...
  musik: "border-purple-200/80 bg-purple-50 text-purple-900",
  music: "border-purple-200/80 bg-purple-50 text-purple-900",
  creator: "border-teal-200/80 bg-teal-50 text-teal-900",
  coaching: "border-emerald-200/80 bg-emerald-50 text-emerald-900",
