...
export function MarketingGroupPreviewList({
  ...
  return (
    <>
      ...
      {selected ? (
        <div
          className="fixed inset-0 z-[70] overflow-y-auto overscroll-contain bg-black/45 px-4 py-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))]"
          role="presentation"
        ...
        >
          <div className="flex min-h-full items-center justify-center py-4">
            <div
              ...
              className="my-auto w-full max-w-lg max-h-[min(90dvh,40rem)] overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl"
            ...
            >
              ...
              <div className="mt-5 flex flex-col gap-2 sm:flex-row-reverse">
                <button
                  type="button"
                  onClick={() => {
                    const returnTo = `/community/${communitySlug}/group/${selected.slug}`;
                    setSelectedId(null);
                    requestAppEntry({ tone: "group", returnTo });
                  }}
