...
/**
 * Header „App nutzen“: direkt in die Connect-App (Discover).
 * Dort erscheint das Erstbesuch-Greeting inkl. Web-App-Installation.
 * Hinweis-Dialog bleibt nur bei Gruppen/Events/Inhalts-CTAs.
 */
